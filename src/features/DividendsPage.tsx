...
export function DividendsPage({ data, identity, reload, onNavigate, onGuestSave }: { data: RetirementOverview; identity: ClaimsIdentity; reload: () => Promise<void>; onNavigate: (page: string) => void; onGuestSave?: (draft: Draft) => Promise<void> }) {
  ...
  async function submit(event: FormEvent) {
    ...
    setMessage('')
    try {
      if (onGuestSave) await onGuestSave(draft)
      else await saveDividendCalendarEvent(identity.id, {
